...
-- Functionality for ESP (Box ESP creation and updating)
...
-- UI Settings Tab and Keybinding
local MenuGroup = Tabs['UI Settings']:AddLeftGroupbox('Menu')
MenuGroup:AddButton('Unload', function() Library:Unload() end)

-- Store the KeyPicker in the Options table
local Options = {}
Options.MenuKeybind = MenuGroup:AddLabel('Menu bind'):AddKeyPicker('MenuKeybind', { Default = 'End', NoUI = true, Text = 'Menu keybind' })

-- Set the ToggleKeybind properly
Library.ToggleKeybind = Options.MenuKeybind.Value -- Use Value to get the keybind value
